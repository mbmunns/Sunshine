...
import edu.unmc.sunshine.app.data.WeatherContract;
import edu.unmc.sunshine.app.data.WeatherContract.WeatherEntry;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        if (unitType.equals(mContext.getString(R.string.pref_units_imperial))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        } else if (unitType.equals(mContext.getString(R.string.pref_units_kelvin))) {
            high = high + 273.15;
            low = low + 273.15;
